...
```shell
claude mcp add --scope user litterbox -- /path/to/agentkit-litterbox stdio
```

## Adding an agent

Create a new agent in your Claude Code configuration directory's `agents` subdirectory. We suggest you name it `litterbox.md`:
