...
AgentKit is distributed as a set of binaries which you'll need to [download from the latest release](https://github.com/throwparty/agentkit/releases/latest), extract, make executable, and place on your `PATH`.
