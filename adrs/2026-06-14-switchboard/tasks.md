...
- `crates/agentkit-switchboard/src/provider/quota.rs` — `ProviderQuotaBehaviour` trait, generic state
- `crates/agentkit-switchboard/src/provider/openai.rs` — OpenAI quota impl (`OpenAiQuota`)
- `crates/agentkit-switchboard/src/provider/anthropic.rs` — Anthropic quota impl (`AnthropicQuota`)
